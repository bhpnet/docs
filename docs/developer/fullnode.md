...
or you can download the pre-build binaries from [release page](https://github.com/bhpnet/bhp/releases/latest) or follow the instructions below:

```bash
# Linux
wget --no-check-certificate https://github.com/bhpnet/bhp/releases/download/v1.0.2/geth_linux
# MacOS
wget --no-check-certificate https://github.com/bhpnet/bhp/releases/download/v1.0.2/geth_mac
```
...
```bash
## mainet
wget --no-check-certificate  $(curl -s https://api.github.com/repos/bhpnet/bhp/releases/latest |grep browser_ |grep mainnet |cut -d\" -f4)
unzip mainnet.zip

## testnet
wget --no-check-certificate  $(curl -s https://api.github.com/repos/bhpnet/bhp/releases/latest |grep browser_ |grep testnet |cut -d\" -f4)
unzip testnet.zip
```
...
you can monitor the log from `/node/bhp.log` by default.
